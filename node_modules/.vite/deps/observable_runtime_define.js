...
function FileAttachment(name, base = document.baseURI) {
...
var AbstractFile = class {
  ...
  async arrow() {
    const [Arrow2, response] = await Promise.all([import("https://cdn.jsdelivr.net/npm/apache-arrow/+esm"), remote_fetch(this)]);
  ...
  async parquet() {
    const [Arrow2, Parquet, buffer] = await Promise.all([import("https://cdn.jsdelivr.net/npm/apache-arrow/+esm"), import("https://cdn.jsdelivr.net/npm/parquet-wasm/+esm").then(async (Parquet2) => (await Parquet2.default("https://cdn.jsdelivr.net/npm/parquet-wasm/esm/parquet_wasm_bg.wasm"), Parquet2)), this.arrayBuffer()]);
...
var Arrow = () => import("https://cdn.jsdelivr.net/npm/apache-arrow/+esm");
var d3 = () => import("https://cdn.jsdelivr.net/npm/d3/+esm");
var dot = () => import("./dot-QEI6DWLQ.js").then((_2) => _2.dot);
var duckdb = () => import("https://cdn.jsdelivr.net/npm/@duckdb/duckdb-wasm/+esm");
var DuckDBClient = () => import("./duckdb-ZRKO73PO.js").then((_2) => _2.DuckDBClient);
...
var Inputs = () => import("./inputs-QTJP3CKD.js");
var L = () => import("./leaflet-T3Z4UI6C.js");
var mapboxgl = () => import("./mapboxgl-PKUDUD24.js").then((_2) => _2.default);
var md = () => import("./md-EDKBN7KF.js").then((_2) => _2.md);
var mermaid = () => import("./mermaid-MITTC2IK.js").then((_2) => _2.mermaid);
...
var tex = () => import("./tex-S3J43ACE.js").then((_2) => _2.tex);
var topojson = () => import("https://cdn.jsdelivr.net/npm/topojson-client/+esm");
var vl = () => import("./vega-lite-XZ6C7ZJY.js").then((_2) => _2.vl);
...
var runtime = Object.assign(new Runtime({ ...library, __ojs_runtime: () => runtime }), { fileAttachments });
var main = runtime.main = runtime.module();
...
function define(state, definition, observer = observe) {
  ...
  if (output != null) {
    if (autoview) {
      ...
      variables.push(
        main.define(output, inputs, body),
        // initial value
...
//# sourceMappingURL=observable_runtime_define.js.map
